        ...
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    ...
                    description="Our AI ad generator instantly creates professional lifestyle images and short-form marketing videos optimized for social media ads, commercials, and Instagram Reels."
                />
